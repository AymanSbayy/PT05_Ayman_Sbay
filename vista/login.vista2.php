...
<body>
    <div class="register-form">
        ...
        <form action="../model/login.php" method="post">
            ...
            <a href="<?php echo $client->createAuthUrl() ?>" style="background-color: #fff; color: #737373; border-radius: 2px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.25); height: 40px; padding: 0 16px; font-size: 14px; line-height: 40px; font-family: Roboto, sans-serif; text-transform: uppercase; letter-spacing: 0.2px; border: none; display: inline-flex; align-items: center;">
            ...
            <a href="<?php echo $client->createAuthUrl() ?>" style="background-color: #24292e; color: #fff; border-radius: 2px; box-shadow: 0 2px 4px 0 rgba(0,0,0,0.25); height: 40px; padding: 0 16px; font-size: 14px; line-height: 40px; font-family: Roboto, sans-serif; text-transform: uppercase; letter-spacing: 0.2px; border: none; display: inline-flex; align-items: center;">
                <svg viewBox="0 0 16 16" width="20px" height="20px" fill="#fff" style="margin-right: 10px;">
            ...
            <p style="margin-top: -10px; float: left;"><a href="../index.php">Tornar</a>.</p>
